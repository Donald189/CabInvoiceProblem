...
namespace CabInvoiceGenerator
{
    public class InvoiceGenerator
    {
        ...
        public InvoiceGenerator(RideType rideType)
        {
            ...
            {
                throw new CabInvoiceException(CabInvoiceException.ExceptionType.INVALID_RIDE_TYPE,"Ivalid Ride");
            }
        }
        ...
        public double CalculateFare(double distance, int time)
        {
            ...
            }catch (CabInvoiceException)
            {
                ...
                if (time < 0)
                {
                    throw new CabInvoiceException(CabInvoiceException.ExceptionType.INVALID_TIME, "Invalid Timr");
                }
            }
            return totalFare;
        }
